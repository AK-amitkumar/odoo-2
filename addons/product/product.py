...
class product_product(osv.osv):
    ...
    def _compute_uos_qty(self, cr, uid, id, uom, qty, uos=False, context=None):
        '''
        Computes product's invoicing quantity in UoS from quantity in UoM.
        Takes into account the
        :param uom: Source unit
        :param qty: Source quantity
        :param uos: Target UoS quantity. By default uses sproduct's UoS
        '''
        context = context or {}
